:project-name: miq-ServiceNow
:project-repo: https://github.com/rhtconsulting/miq-ServiceNow
:project-zip: https://github.com/rhtconsulting/miq-ServiceNow/archive/master.zip
